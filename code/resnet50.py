...
def unpickle():
    ...
    my_dict={}
    files = os.listdir('/mydata/dataset/Imagenet32_train')
    for file in files:
        with open('/mydata/dataset/Imagenet32_train/'+file, 'rb') as fo:
            d = pickle.load(fo)
...
t = unpickle_test('/mydata/dataset/Imagenet32_val/val_data')
test = t['data']
